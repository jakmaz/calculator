...
function App() {
    ...
    return (
        <main className={`${darkMode && "dark"} transition duration-500 ease-in-out main bg-[#E7E7E8] flex justify-center items-center h-screen`}>
            <div className="flex flex-col shadow-xl screen bg-screenPrimary w-[390px] h-[844px] rounded-[30px]">
                <div className="px-8 py-3 font-bold phone-bar text-numbers">
                    <p>{new Date().toLocaleTimeString('en-US', { hour12: false, hour: '2-digit', minute: '2-digit' })}</p>
                </div>
                <div
                ...
                <div className="flex flex-grow flex-col justify-end p-6 px-10 text-end text-2xl font-bold text-numbers">
                    <p className={`m-2`}>{formatOperand(previousOperand)} {operation}</p>
                ...
                <div className="h-3/5 w-full p-6 pb-16 bg-screenSecondary rounded-[30px]">
                    <div className="grid h-full grid-cols-4 grid-rows-5 gap-4 keyboard">
                        <OperationButton className="text-mathOperationsTop" operation="AC" dispatch={dispatch}/>
                        <OperationButton className="text-mathOperationsTop" operation="C" dispatch={dispatch}/>
                        <OperationButton className="text-mathOperationsTop" operation="%" dispatch={dispatch}/>
                        <OperationButton className="text-mathOperationsTop" operation="÷" dispatch={dispatch} />
                        <DigitButton digit="7" dispatch={dispatch} />
                        <DigitButton digit="8" dispatch={dispatch} />
                        <DigitButton digit="9" dispatch={dispatch} />
                        <OperationButton className="text-mathOperationsRight" operation="x" dispatch={dispatch} />
                        <DigitButton digit="4" dispatch={dispatch} />
                        <DigitButton digit="5" dispatch={dispatch} />
                        <DigitButton digit="6" dispatch={dispatch} />
                        <OperationButton className="text-mathOperationsRight" operation="-" dispatch={dispatch} />
                        ...
                        <OperationButton className="col-span-2 text-mathOperationsRight" operation="=" dispatch={dispatch} />
                    </div>
